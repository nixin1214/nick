<div class="row">
	<div class="col-md-12">
		<table class="table table-striped">
            ...
            <tr>
            	<td>名称：</td>
            	<td>${dictionaryList.fieldKey?if_exists}</td>
            </tr>
            <tr>
            	<td>默认值:</td>
            	<td>${dictionaryList.fieldValue?if_exists}</td>
            </tr>
            <tr>
            	<td>排序:</td>
            	<td>${dictionaryList.sort?if_exists}</td>
            </tr>
            <tr>
            	<td>创建时间：</td>
            ...
            <tr>
            	...
            	<td>${dictionaryList.remark?if_exists}</td>
            </tr>
     	</table>
