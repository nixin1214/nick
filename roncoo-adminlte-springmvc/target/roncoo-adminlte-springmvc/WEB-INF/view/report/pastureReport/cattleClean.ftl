                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">育成牛死淘数据分析(单位:头)</h3>
                                    <div class="box-tools pull-right">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <#list ymap?keys as qj>
                                                <#assign vmap = ymap[qj]>
                                                <#assign vmap = ymap[qj]>
                                                <#if vmap["YCNSTL-SW-TS"]==0&&vmap["YCNSTL-TT-TS"]!=0>
                                                    <td>-</td>
                                                    <td>${vmap["YCNSTL-TT-TS"]}</td>
                                                <#elseif vmap["YCNSTL-TT-TS"]==0&&vmap["YCNSTL-SW-TS"]!=0>
                                                    <td>${vmap["YCNSTL-SW-TS"]}</td>
                                                    <td>-</td>
                                                <#elseif vmap["YCNSTL-SW-TS"]==0&&vmap["YCNSTL-TT-TS"]==0>
                                                    <td>-</td>
                                                    <td>-</td>
                                                <#else >
                                                <td>${vmap["YCNSTL-SW-TS"]}</td>
...
<script type="text/javascript">
    ...
    function cattleClean(yearMonth) {
        $.ajax({
            url: "${ctx}/report/pastureReport/cattleCleanAjax?companyNumber=${companyNumber}&company=${company}&yearMonth="+yearMonth,
            type: "get",
            dataType: "text",
    ...
    function everydayChart(yearMonths) {
        $.ajax({
            url: "${ctx}/report/pastureReport/cattleEveryAjax?companyNumber=${companyNumber}&company=${company}&yearMonths="+yearMonths,
            type: "get",
            dataType: "text",
            success: function(result){
                var jsonObj = eval('(' + result + ')');
