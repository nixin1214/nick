            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-green">
                        ...
                        <div class="info-box-content">
                            ...
                            <#--<#if bnlj == "ZHZB-YYSR-BNLJ-WY">
                                <#assign result = resultMap["ZHZB-YYSR-BNLJ-WY"]>
                            ${result?floor}
                            <#else >
                                0
                            </#if>-->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-yellow">
                        ...
                        <#--<#assign lastMonth = resultMap["yearMonth"][1]>-->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-purple">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">
                                <#if (resultList[2]>0)>
                                ${(resultList[0]-resultList[2])/resultList[3]*100}
                        ...
                        <#--<#assign lastYearMonth = resultMap["yearMonth"][0]>-->
...
<script type="text/javascript">
    ...
    function businessIncomeDetail(yearMonthone) {
        $.ajax({
                url: "${ctx}/report/pastureReport/businessIncomeDetailAjax?companyNumber=${companyNumber}&company=${company}&yearMonthone="+yearMonthone,
            type: "get",
            dataType: "text",
    ...
    function summaryDataAjax(yearMonth) {
        ...
        var rowIndex = [30, 31, 32, 33, 34, 35, 36];
        $.ajax({
    ...
    function init(result) {
        ...
        var ZHZBSN = [];//营业收入去年同期数据
        for (var i = 0; i < result['yearMonth'].length; i++) {
            if (result['ZHZB-YYSR-WY'].length > 0) {
                seriesZYYWCB.push(Math.round(result['ZHZB-YYSR-WY'][i]));
            }
            if (result['ZHZB-YYSR-YSMB-WY'].length > 0) {
                seriesZYYWJSR.push(Math.round(result['ZHZB-YYSR-YSMB-WY'][i]));
            }
            if (result['ZHZB-YYSR-BQSN-WY'].length > 0) {
                ZHZBSN.push(Math.round(result['ZHZB-YYSR-BQSN-WY'][i]));
            }
        }
        console.log(seriesZYYWCB);
