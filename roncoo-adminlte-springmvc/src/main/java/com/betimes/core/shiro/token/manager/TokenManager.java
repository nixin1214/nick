package com.betimes.core.shiro.token.manager;

import com.betimes.common.utils.SpringContextUtil;
import com.betimes.core.shiro.session.CustomSessionManager;
import com.betimes.core.shiro.token.ShiroToken;
import com.roncoo.adminlte.bean.entity.RcUser;
import com.roncoo.adminlte.controller.realm.UserRealm;
...
public class TokenManager {
	//用户登录管理
	public static final UserRealm realm = SpringContextUtil.getBean("sampleRealm",UserRealm.class);
	//用户session管理
	 ...
	 * @return
	 */
	public static RcUser getToken(){
		RcUser token = (RcUser) SecurityUtils.getSubject().getPrincipal();
		return token ;
	}
	 ...
	 * @return
	 */
	public static RcUser login(RcUser user,Boolean rememberMe){
		ShiroToken token = new ShiroToken(user.getUserNo(), user.getPassword());
