package com.betimes.core.shiro.service.impl;

import com.betimes.common.config.INI4j;
import com.betimes.core.shiro.service.ShiroManager;
...
public class ShiroManagerImpl implements ShiroManager {
	...
	private String getFixedAuthRule(){
		...
		try {
			...
			logger.error("加载文件出错{}, errMsg:{}", fileName, e);
		}
...
//		ShiroFilterFactoryBean shiroFilterFactoryBean = (ShiroFilterFactoryBean) SpringContextUtil.getBean("shiroFilterFactoryBean");
		...
		try {
			...
			logger.error("getShiroFilter from shiroFilterFactoryBean error!");
