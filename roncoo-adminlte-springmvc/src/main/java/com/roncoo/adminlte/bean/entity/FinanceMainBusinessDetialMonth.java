 ...
 */
public class FinanceMainBusinessDetialMonth implements Serializable{
    private Long fid;
    ...
    public FinanceMainBusinessDetialMonth() {
    }

    public FinanceMainBusinessDetialMonth(Long fid, String frow_num, String fproject, BigDecimal sales_volume, BigDecimal selling_unit_price, BigDecimal selling_amont, BigDecimal cost_unit, BigDecimal cost_amont, BigDecimal sale_profit_unit, BigDecimal sale_profit_count, BigDecimal sale_profit_ratio, Long fhead_id, int frow_index, int fstrong) {
        this.fid = fid;
