...
public class TFinanceMilkCostTotal implements Serializable {
    private Long fid;
    ...
    public BigDecimal getFyieldLast() {
        return fyieldLast;
    }

    public void setFyieldLast(BigDecimal fyieldLast) {
        this.fyieldLast = fyieldLast;
    }
    ...
    public BigDecimal getFmaterialLast() {
        return fmaterialLast;
    }

    public void setFmaterialLast(BigDecimal fmaterialLast) {
        this.fmaterialLast = fmaterialLast;
    }
    ...
    public BigDecimal getFpackageLast() {
        return fpackageLast;
    }

    public void setFpackageLast(BigDecimal fpackageLast) {
        this.fpackageLast = fpackageLast;
    }
    ...
    public BigDecimal getFlaborCostLast() {
        return flaborCostLast;
    }

    public void setFlaborCostLast(BigDecimal flaborCostLast) {
        this.flaborCostLast = flaborCostLast;
    }
    ...
    public BigDecimal getFpowerCostLast() {
        return fpowerCostLast;
    }

    public void setFpowerCostLast(BigDecimal fpowerCostLast) {
        this.fpowerCostLast = fpowerCostLast;
    }
    ...
    public BigDecimal getFmanufCostLast() {
        return fmanufCostLast;
    }

    public void setFmanufCostLast(BigDecimal fmanufCostLast) {
        this.fmanufCostLast = fmanufCostLast;
    }
