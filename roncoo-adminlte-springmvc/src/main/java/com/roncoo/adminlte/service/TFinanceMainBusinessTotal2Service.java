 ...
 */
public interface TFinanceMainBusinessTotal2Service {

    int insert(TFinanceMainBusinessTotal2 empSalary);
    ...
    List<TFinanceMainBusinessTotal2> queryByPropertyAll(List<Long> tfheadids);
