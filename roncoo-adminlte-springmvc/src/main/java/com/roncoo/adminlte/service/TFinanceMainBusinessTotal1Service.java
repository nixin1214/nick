 ...
 */
public interface TFinanceMainBusinessTotal1Service {

    int insert(TFinanceMainBusinessTotal1 empSalary);
    ...
    List<TFinanceMainBusinessTotal1> queryByPropertyAll(List<Long> tfheadids);
