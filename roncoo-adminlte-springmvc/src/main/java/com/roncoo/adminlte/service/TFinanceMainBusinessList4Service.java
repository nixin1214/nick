 ...
 */
public interface TFinanceMainBusinessList4Service {

    int insert(TFinanceMainBusinessList4 empSalary);
    ...
    List<TFinanceMainBusinessList4> queryByPropertyAll(List<Long> tfheadids);
