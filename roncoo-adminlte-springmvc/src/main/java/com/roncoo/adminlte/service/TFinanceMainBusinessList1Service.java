 ...
 */
public interface TFinanceMainBusinessList1Service {

    int insert(TFinanceMainBusinessList1 empSalary);
    ...
    List<TFinanceMainBusinessList1> queryByPropertyAll(List<Long> tfheadids);
