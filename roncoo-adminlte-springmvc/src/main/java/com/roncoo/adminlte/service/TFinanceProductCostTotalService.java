 ...
 */
public interface TFinanceProductCostTotalService {

    int insert(TFinanceProductCostTotal empSalary);
    ...
    List<TFinanceProductCostTotal> queryByPropertyAll(List<Long> tfheadids);
