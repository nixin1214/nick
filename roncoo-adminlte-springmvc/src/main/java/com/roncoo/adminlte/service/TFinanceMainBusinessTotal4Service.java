 ...
 */
public interface TFinanceMainBusinessTotal4Service {

    int insert(TFinanceMainBusinessTotal4 empSalary);
    ...
    List<TFinanceMainBusinessTotal4> queryByPropertyAll(List<Long> tfheadids);
