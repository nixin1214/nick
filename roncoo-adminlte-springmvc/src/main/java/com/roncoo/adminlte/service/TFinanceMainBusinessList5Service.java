 ...
 */
public interface TFinanceMainBusinessList5Service {

    int insert(TFinanceMainBusinessList5 empSalary);
    ...
    List<TFinanceMainBusinessList5> queryByPropertyAll(List<Long> tfheadids);
