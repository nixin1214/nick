 ...
 */
public interface TFinanceMainBusinessList6Service {

    int insert(TFinanceMainBusinessList6 empSalary);
    ...
    List<TFinanceMainBusinessList6> queryByPropertyAll(List<Long> tfheadids);
