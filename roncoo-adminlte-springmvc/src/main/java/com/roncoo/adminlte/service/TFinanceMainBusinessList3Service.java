 ...
 */
public interface TFinanceMainBusinessList3Service {

    int insert(TFinanceMainBusinessList3 empSalary);
    ...
    List<TFinanceMainBusinessList3> queryByPropertyAll(List<Long> tfheadids);
