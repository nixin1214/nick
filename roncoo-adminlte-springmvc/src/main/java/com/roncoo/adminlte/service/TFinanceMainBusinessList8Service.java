 ...
 */
public interface TFinanceMainBusinessList8Service {

    int insert(TFinanceMainBusinessList8 empSalary);
    ...
    List<TFinanceMainBusinessList8> queryByPropertyAll(List<Long> tfheadids);
