 ...
 */
public interface TFinanceMainBusinessTotal3Service {

    int insert(TFinanceMainBusinessTotal3 empSalary);
    ...
    List<TFinanceMainBusinessTotal3> queryByPropertyAll(List<Long> tfheadids);
