 ...
 */
public interface TFinanceMainBusinessList7Service {

    int insert(TFinanceMainBusinessList7 empSalary);
    ...
    List<TFinanceMainBusinessList7> queryByPropertyAll(List<Long> tfheadids);
