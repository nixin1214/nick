 ...
 */
public interface TFinanceProductCostThisService {

    int insert(TFinanceProductCostThis empSalary);
    ...
    List<TFinanceProductCostThis> queryByPropertyAll(List<Long> tfheadids);
