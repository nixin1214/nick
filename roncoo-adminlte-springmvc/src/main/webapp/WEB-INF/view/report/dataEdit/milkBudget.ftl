                            ...
                            <div class="clearfix">
                                <div class="col-md-7">
                                    <div class="input-group">
                                        ...
                                        <button type="button" class="btn btn-info" onclick="window.location.href='${ctx}/report/dataEdit/downloadTempFile?tempType=HSMRY_BUDGET'"><i class="glyphicon glyphicon-export icon-share"></i>模板下载</button>
                                    </div>
                                </div>
                            </div><br/>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        role_tab = $('#quota_tab').DataTable({
            ...
            "ajax":{"url":"${ctx}/report/dataEdit/page4","type":"post"},
            "columns":[
                {"data":null},
                {"data":"fyearMonth"},
                {"data":"fnameZh"},
        ...
        $("#uploadBtn").on("click", function () {
            ...
            var url = baseUrl + "/report/dataEdit/milkBudget";
